...
export default function RecipesListScreen(props) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            console.log(user);
            const resp = await fetch("https://localhost:44314/api/UserRecipe/GetRecipesByUser/" + user.email);
    ...
    return (
        <ScrollView
            ...
            <Text style={styles.subtitle}>Sorteaza retetele tale favorite:</Text>
