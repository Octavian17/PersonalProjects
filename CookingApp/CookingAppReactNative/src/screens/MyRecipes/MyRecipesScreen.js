...
export default function MyRecipesScreen(props) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            console.log(user);
            const resp = await fetch("https://localhost:44314/api/RecipeByUser/GetRecipesByUser/" + user.email);
    ...
    const goToAddRecipeScreen = () => {
        navigation.navigate("Adauga reteta");
    };
    ...
    return (
        <ScrollView
            ...
            <TouchableOpacity style={[styles.sort, { margin: 30, marginLeft: 120, width: 150 }]} onPress={goToAddRecipeScreen}>
                <Text style={{ color: 'white' }}>Adauga reteta</Text>
            </TouchableOpacity>
            <Text style={styles.subtitle}>Sorteaza retetele tale:</Text>
